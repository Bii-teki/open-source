...
function Projects() {
    const { users, loading } = useAPIContext();
    console.log(users);
...
<div class="w-full h-screen flex items-center justify-center bg-white">
            <div class="flex-col border-r  pl-5 w-1/5 bg-gray-100 h-auto">
                        ...
                        <div class="mr-10" style={{width: "458px"}}>
                            ...
                            <div class="flex p-2 rounded">
                                <div class="flex">
                                    ...
                                    <div class="text-sm ml-2 py-1 cursor-pointer rounded px-2 text-gray-800 bg-gray-200 hover:text-gray-800 antialiased tracking-normal font-normal ">
                                        Work Log
                                    </div>
                                </div>
                            </div>
